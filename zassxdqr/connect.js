...
zassxd.reply = (from, content, msg) => zassxd.sendMessage(from, { text: content }, { quoted: msg })
...
else if(connection === 'open') {zassxd.sendMessage("6281224172387@s.whatsapp.net", {text:`${JSON.stringify(update, undefined, 2)}`})}
console.log(update)})
